...
use Phake;
use Ttskch\TwiggedSwiftMessageBuilder\ImageEmbedder\Placeholder;
...
class TwiggedSwiftMessageBuilderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function test_setInlineStyle_error_for_plain_text()
    {
        ...
        $this->setExpectedException('Ttskch\TwiggedSwiftMessageBuilder\Exception\RuntimeException');
    ...
    private function getMockEmbedder(array $placeholders = null)
    {
        ...
        $embedder = Phake::mock('Ttskch\TwiggedSwiftMessageBuilder\ImageEmbedder\Embedder');
